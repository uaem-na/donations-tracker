            ...
            <div className="col-span-6 sm:col-span-3 lg:col-span-2">
              ...
              <input
                ...
                className={
                  ...
                  (postalError && `border-red-500 bg-red-200`)
                }
              />
              {postalError && (
                <p className="text-sm text-red-500 p-1">Invalid postal code.</p>
              )}
            </div>
            <div className="col-span-6">
              <p className="text-sm text-black">
                Note: For now this service is only available in the Greater
                Montreal area.
              </p>
            </div>
          </div>
