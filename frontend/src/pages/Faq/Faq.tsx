          ...
          <dl className="mt-10 space-y-6 divide-y divide-gray-900/10">
            <FaqItem question="What is Donations Tracker?">
              <p className="mb-3 leading-5">
                Donations Tracker is an online platform aimed at promoting
                donation sharing in Montréal. On this platform, users can
                request and offer donations. In doing so, our goal is to
                strengthen community solidarity and reduce socioeconomic
                disparities here in Montréal.
              </p>
            </FaqItem>
              ...
              <p className="mb-3 leading-5">
                <ol className="list-inside my-5 list-decimal marker:font-semibold">
                  <li className="mb-3 d leading-5">
                    ...
                    <p className="mb-3 leading-5">
                      Click on “Login” on the top right then click “Click here
                      to register.”
                    </p>
                    <p className="mb-3 leading-5">
                      You can register as an individual or an organization. For
                      more information on their differences, please read “What
                      is the difference between registering as an individual vs.
                      organization?” below.
                    </p>
                  </li>
                  <li className="mb-3 d">
                    <span className="font-semibold">
                      MAKE AN OFFER AND/OR REQUEST.
                    </span>
                    <p className="mb-3 leading-5">
                      Once you log in, click on “Posts” in the menu bar on the
                      left. Click on “Make an Offer” or “Make a Request” and
                      fill in the appropriate information.
                    </p>
                    <p className="mb-3 leading-5 text-sm">
                      Note: Only specific users can make a request. For more
                      information, please see “What is the difference between
                      registering as an individual vs. organization?” below.
                    </p>
                    <p className="mb-3 leading-5 text-sm">
                      Note: The current version of the website allows
                      purchasing/selling of products. If you want to
                      offer/request a donation, please input ‘0’ as the price.
                    </p>
                  </li>
                  <li className="mb-3 d">
                    <span className="font-semibold">
                      EXPLORE THE “POSTS” PAGE FOR ANY OFFERS/REQUESTS YOU WANT
                      TO RESPOND TO.
                    </span>
                    <p className="mb-3 leading-5">
                      Scroll through the offers/requests listed on “Posts.” You
                      might have products another user may need! Or, another
                      user may be offering items that you want!
                    </p>
                    <p className="mb-3 leading-5">
                      Use the filters on the left to look at specific posts. You
                      can also add certain posts to your “Favorites” by clicking
                      on the star button.
                    </p>
                  </li>
                  <li className="mb-3 d">
                    <span className="font-semibold">
                      CLICK ON THE OFFER/REQUEST THAT YOU WANT. CONTACT THE
                      OTHER USER THROUGH EMAIL LISTED ON THE POST.
                    </span>
                    <p>
                      All communication/transactions between users must occur
                      outside of the Donations Tracker platform.
                    </p>
                  </li>
                  <li className="mb-3 d">
                    <span className="font-semibold">
                      COMMUNICATE WITH THE OTHER USER TO COMPLETE THE
                      TRANSACTION/DONATION.
                    </span>
                  </li>
                  <li className="mb-3 d">
                    <span className="font-semibold">
                      CONGRATULATIONS! YOUR OFFER/REQUEST HAS BEEN FULFILLED!
                      LASTLY, PLEASE CLOSE YOUR POST ON THE WEBSITE.
                    </span>
                    <p>
                      It is important that you close your completed
                      offers/requests so that other users know that it’s no
                      longer active. We thank you for your cooperation!
                    </p>
                  </li>
                </ol>
              </p>
            ...
            <FaqItem question="What is the “Other” category in requests/offers?">
              <p className="mb-3 leading-5">
                “Other” is a category option provided when users make an
                offer/request.
              </p>
              <p className="mb-3 leading-5">
                The “Other” category is to be used when the item(s) being
                offered/requested do not fit any of the alternative categories
                listed. When using the “Other” category, users are to describe
                or specify the item(s) in the description of the post. This post
                will then be approved/denied to go public by the Donations
                Tracker moderators to ensure that no contraband/illegal items
                are being offered or requested on the Donations Tracker website.
                Once approved, the user that made the post will be e-mailed that
                their post has been approved and the offer/request will be
                posted allowing all Donations Tracker users to be able to see
                and interact with the post.
              </p>
            </FaqItem>
            ...
            <FaqItem question="What can I do on the “Account” page?">
              ...
              <ul className="list-disc list-inside my-5">
                <li className="mb-3">
                  Dashboard: Users can view their own posts as well as posts
                  marked as their “Favorite.”
                </li>
                <li className="mb-3">
            ...
            <FaqItem question="How is Donations Tracker different from other product-sharing websites?">
              <p className="mb-3 leading-5">
                ...
                website, Donations Tracker stands out from other product-sharing
                platforms in the sense that it promotes donation sharing. The
                development team realized that despite there being numerous
                platforms to sell/purchase products, there is a lack of
            ...
            >
              ...
              <p className="mb-3 leading-5">
                Registering as an organization makes it mandatory that the user
                be associated with a legitimate organization. The legitimacy of
                the organization will be approved by the website administrators
                during registration. For the purpose of the website, for now, it
                is required that the organization be based in the Greater
                Montréal area. Organization users can make both offers and
                requests.
              </p>
            </FaqItem>
            ...
            <FaqItem question="How can users be sure that the website is secure?">
              ...
              <ul className="list-disc list-inside my-5">
                ...
                <li className="mb-3">
                  ...
                  found on the _____. Once a user has been reported, their
                  activity will be temporarily blocked until the website
                  administrators conduct a background check.
                </li>
              </ul>
            </FaqItem>
