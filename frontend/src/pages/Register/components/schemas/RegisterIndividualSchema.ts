...
export const registerIndividualSchema = yup.object().shape({
  ...
  username: yup
    ...
    .min(3, "Must be 3 characters or more")
    .max(32, "Must be less than 32 characters")
    .test("test-word-profanity", "Username cannot contain profane words", (value) => (!isProfane(value!)))
  ...
  firstName: yup
    ...
    .test("test-word-profanity", "First name cannot contain profane words", (value) => (!isProfane(value!)))
  ...
  lastName: yup
    ...
    .test("test-word-profanity", "Last name cannot contain profane words", (value) => (!isProfane(value!)))
